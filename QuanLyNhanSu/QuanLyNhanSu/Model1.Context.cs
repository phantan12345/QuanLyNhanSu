...
namespace QuanLyNhanSu
{
    ...
    public partial class NhanSuEntities : DbContext
    {
        ...
        public virtual int CheckEmployee(string sDT, ObjectParameter result)
        {
            var sDTParameter = sDT != null ?
                new ObjectParameter("SDT", sDT) :
                new ObjectParameter("SDT", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CheckEmployee", sDTParameter, result);
        }
